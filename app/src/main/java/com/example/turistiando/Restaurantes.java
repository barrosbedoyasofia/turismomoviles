...
public class Restaurantes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorDrawable colorBarra= new ColorDrawable(Color.parseColor("#e9967a"));
    ...
    public void crearListaRestaurante(){
        ...
        lista2.add(new Hotel(R.drawable.restaurante32,getString(R.string.NombreRes1),getString(R.string.desRestaurante1),getString(R.string.PrecioRes1)));
        lista2.add(new Hotel(R.drawable.restaurante2,getString(R.string.NombreRes2),getString(R.string.desRestaurante2),getString(R.string.PrecioRes2)));
        lista2.add(new Hotel(R.drawable.restaurante4,getString(R.string.NombreRes3),getString(R.string.desRestaurante3),getString(R.string.PrecioRes3)));
        lista2.add(new Hotel(R.drawable.restaurante45,getString(R.string.NombreRes4),getString(R.string.desRestaurante4),getString(R.string.PrecioRes4)));
